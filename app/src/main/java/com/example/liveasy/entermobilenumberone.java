...
public class entermobilenumberone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getotpbutton =findViewById(R.id.btn1);
...
//                        startActivity(intent);
                        ...
                        Toast.makeText(entermobilenumberone.this,"Please Enter Correct Number",Toast.LENGTH_LONG).show();
                    }
                }else {
                    Toast.makeText(entermobilenumberone.this,"Please Enter Mobile Number",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
